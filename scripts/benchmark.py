...
def benchmark(repeats: int = 8) -> float:
    ...
    problem_types_and_generators: Dict[str, Callable[[int], Tuple[Scalar, MILP]]] = {
        ...
        #"UFL(n=128, m=16)": lambda seed: generate_UFL(128, 16, seed = seed),
        #"MC(n=64)": lambda seed: generate_MC(64, density=3/4, seed=seed),
        #"TSP(n=12)": lambda seed: generate_TSP(12, seed=seed),
        #"BP(n=128, m=8)": lambda seed: generate_BP(128, 8, seed=seed),
